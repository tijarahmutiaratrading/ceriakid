export const MINI_GAME_CATEGORIES = [
  ...
  { id: 'bahasa_melayu', title: 'Bahasa Melayu', emoji: '📚', color: 'from-emerald-500 to-green-400', objective: 'Suku kata, perkataan dan ayat mudah.', games: [
    { id: 'suku-kata-builder', title: 'Suku Kata Builder', emoji: '🧩', mode: 'wordbuilder', difficulty: 'Mudah', objective: 'Bina perkataan KVKV.', instruction: 'Tap suku kata untuk bina perkataan.', words: ['buku', 'meja', 'bola'], letters: ['bu', 'ku', 'me', 'ja', 'bo', 'la'], reward: 'Badge ejaan' },
    { id: 'kata-swipe', title: 'Kata Nama Swipe', emoji: '👆', mode: 'swipe_select', difficulty: 'Sederhana', objective: 'Bezakan kata nama dan kata kerja.', instruction: 'Pilih kiri untuk Kata Nama, kanan untuk Kata Kerja.', items: [{ text: 'kucing', group: 'Kata Nama' }, { text: 'lari', group: 'Kata Kerja' }, { text: 'buku', group: 'Kata Nama' }], reward: 'Swipe streak' },
  ...
  { id: 'jawi_iqra', title: 'Jawi & Iqra', emoji: '🕌', color: 'from-amber-500 to-yellow-400', objective: 'Kenal huruf Jawi dan bacaan asas.', games: [
    ...
    { id: 'iqra-rhythm', title: 'Iqra Rhythm Tap', emoji: '🥁', mode: 'rhythm_tap', difficulty: 'Sederhana', objective: 'Ikut rentak bacaan mudah.', instruction: 'Tap ikut kelipan rentak.', items: ['ا', 'ب', 'ت', 'ث'], reward: 'Rhythm combo' },
    { id: 'jawi-connect-dots', title: 'Jawi Connect Dots', emoji: '✨', mode: 'connect_dots', difficulty: 'Sederhana', objective: 'Kenal bentuk huruf.', instruction: 'Sambung titik huruf Jawi.', items: ['1', '2', '3', '4'], reward: 'Glowing letter' },
  ]},
  { id: 'memory_logic', title: 'Memory & Logic', emoji: '🧠', color: 'from-fuchsia-500 to-pink-500', objective: 'Ingatan, fokus dan penyelesaian masalah.', games: [
    ...
    { id: 'reaction-tap', title: 'Reaction Speed Tap', emoji: '⚡', mode: 'reaction_speed', difficulty: 'Sukar', objective: 'Latih refleks dan fokus.', instruction: 'Tap bila lampu jadi hijau.', reward: 'Speed medal' },
  ]},

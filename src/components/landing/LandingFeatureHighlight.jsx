...
const HIGHLIGHTS = [
  ...
  },
  {
    ...
    points: [
      '📖 Bahasa Melayu · 🔤 English · ➗ Matematik · 🔬 Sains',
      '🇮🇳 Bahasa Tamil · 🇨🇳 Bahasa Mandarin · ✍️ Jawi',
      '🕌 Pendidikan Islam · 💛 Pendidikan Moral · 🌍 Sejarah',
      '🔧 RBT · 🏃 PJK · 🎨 Seni',
      '🕌 KAFA — Al-Quran, Jawi, Akidah, Ibadah, Sirah, Adab & Bahasa Arab',
    ],

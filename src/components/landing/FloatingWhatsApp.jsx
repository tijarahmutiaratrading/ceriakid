...
export default function FloatingWhatsApp() {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.96 }}
      className="fixed bottom-5 right-4 z-[60] flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-2xl shadow-green-950/30 ring-[3px] ring-white/40 sm:bottom-6 sm:right-6"

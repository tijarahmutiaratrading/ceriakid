...
export default function AdminTopHeader({ activeTab, setActiveTab }) {
  ...
  return (
    <header className={`hidden md:flex fixed top-[5.5rem] left-0 right-0 z-40 justify-center px-4 pointer-events-none transition-transform duration-300 ${isVisible ? 'translate-y-0' : '-translate-y-[200%]'}`}>

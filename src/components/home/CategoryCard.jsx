...
const categoryConfigs = {
  ...
  pendidikan_moral: { emoji: '🤝', label: 'Pendidikan Moral', color: 'from-rose-300 via-pink-400 to-fuchsia-500', accentBg: 'bg-rose-100/30' },
  sejarah: { emoji: '📜', label: 'Sejarah', color: 'from-amber-400 via-orange-500 to-red-500', accentBg: 'bg-amber-100/30' },
  rbt: { emoji: '🔧', label: 'Reka Bentuk & Teknologi', color: 'from-slate-400 via-cyan-500 to-blue-600', accentBg: 'bg-cyan-100/30' },
  pjk: { emoji: '⚽', label: 'PJ & Kesihatan', color: 'from-lime-400 via-green-500 to-emerald-600', accentBg: 'bg-lime-100/30' },
  seni: { emoji: '🎨', label: 'Seni Visual', color: 'from-fuchsia-400 via-purple-500 to-indigo-600', accentBg: 'bg-fuchsia-100/30' },

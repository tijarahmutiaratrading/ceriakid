        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 md:divide-x md:divide-slate-100">
          ...
          <div className="md:pr-6">
            ...
            <motion.button
              ...
              className="w-full bg-[#25D366] hover:bg-[#1eb955] text-white rounded-xl font-bold text-xs md:text-sm py-2 md:py-2.5 flex items-center justify-center gap-1.5 md:gap-2 shadow-sm transition-all"
            >

...
export default function FriendsPanel({ onCountChange }) {
  ...
  return (
    <div>
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 sm:divide-x sm:divide-slate-100">
          {/* Kod Undangan */}
          <div className="sm:pr-6">
            ...
            <motion.button
              ...
              className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-xl font-bold text-xs md:text-sm py-2 md:py-2.5 flex items-center justify-center gap-1.5 md:gap-2 shadow-sm transition-all"
            >

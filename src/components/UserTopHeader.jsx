...
export default function UserTopHeader() {
  ...
  return (
    <header
      ref={navRef}
      className={`hidden md:flex fixed top-5 left-0 right-0 z-50 justify-center px-4 pointer-events-none transition-transform duration-300 ${isVisible ? 'translate-y-0' : '-translate-y-[150%]'}`}
    >

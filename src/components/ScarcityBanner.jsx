  ...
  return (
    ...
    >
      ...
      <div className="relative rounded-2xl overflow-hidden shadow-lg">
        ...
        <div className="relative px-3 sm:px-6 py-3 sm:py-4 flex flex-row items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="flex gap-1.5 sm:gap-2 items-center justify-end flex-grow sm:flex-grow-0 pr-1 sm:pr-2">
            {[

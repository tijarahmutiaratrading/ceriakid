        ...
        <div className="relative px-3 sm:px-5 py-3 sm:py-4 flex flex-row items-center justify-between gap-2 sm:gap-4">
          <div className="flex items-center gap-1.5 sm:gap-3 min-w-0 flex-shrink-0">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-white font-black text-[10px] sm:text-sm leading-snug sm:hidden">Harga promo<br/>tamat...</p>
              <p className="text-white font-black text-xs sm:text-sm leading-snug hidden sm:block">Harga promo tamat tengah malam ini!</p>

  ...
  return (
    ...
    >
      ...
      <div className="relative rounded-2xl overflow-hidden shadow-lg">
        ...
        <div className="relative px-3 sm:px-6 pr-8 py-3 sm:py-4 flex flex-row items-center justify-between gap-2 sm:gap-4">
      ...
      <div className="grid grid-cols-2 gap-2 sm:gap-3">
        ...
        >
          ...
          <div className="min-w-0">
            ...
            <p className="text-amber-600 text-[9px] sm:text-[10px] font-semibold leading-tight">pakej terjual</p>
          </div>
        </motion.div>
      </div>
    </motion.div>

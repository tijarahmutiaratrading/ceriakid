        ...
        >
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-5 sm:p-6 border-b border-slate-100">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl brand-gradient-br flex items-center justify-center shadow-lg">
          ...
          <div className="p-5 sm:p-6 space-y-5">
            ...
            <Button
              type="submit"
              disabled={submitting}
              className="w-full brand-gradient text-white font-black py-6 rounded-xl shadow-xl text-base group"
            >
              {submitting ? (

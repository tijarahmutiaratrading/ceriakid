...
function MemoryMode({ data }) {
  ...
  const cards = useMemo(() => shuffle((data.pairs || []).flatMap((pair, pairId) => pair.map((text) => ({ pairId, text })))), []);

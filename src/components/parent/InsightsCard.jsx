...
export default function InsightsCard({ games }) {
  ...
  return (
    <motion.div
      ...
      style={{
        backgroundImage: "url('https://media.base44.com/images/public/69f1c132ffcd7c660466eec5/4a9740090_generated_image.png')",
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        boxShadow: '0 20px 50px -15px rgba(147, 51, 234, 0.45), 0 0 0 1px rgba(255,255,255,0.12) inset',
      }}
    >
      <div className="absolute inset-0 -z-10" style={{ background: 'linear-gradient(135deg, rgba(91,33,182,0.82) 0%, rgba(147,51,234,0.72) 50%, rgba(236,72,153,0.78) 100%)' }} />

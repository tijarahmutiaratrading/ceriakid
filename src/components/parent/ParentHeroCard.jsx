...
export default function ParentHeroCard({ totalChildren, totalGames, totalStars, avgStars }) {
  const stats = [
    { label: 'Anak Didaftarkan', value: totalChildren, icon: Users, iconBg: 'bg-purple-600', change: null },
    { label: 'Jumlah Games', value: totalGames, icon: Gamepad2, iconBg: 'bg-purple-500', change: null },
    { label: 'Jumlah Bintang', value: totalStars, icon: Star, iconBg: 'bg-fuchsia-500', change: null },
    { label: 'Purata Bintang', value: avgStars + ' ⭐', icon: TrendingUp, iconBg: 'bg-pink-500', change: null },
  ];

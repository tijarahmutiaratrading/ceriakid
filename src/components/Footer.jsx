...
export default function Footer() {
  ...
  return (
    <footer className="text-white px-4 py-6 text-center md:py-7 relative w-full" style={{ background: 'linear-gradient(135deg, #1e1b4b 0%, #581c87 50%, #6b21a8 100%)', borderTop: '1px solid rgba(255,255,255,0.1)' }}>

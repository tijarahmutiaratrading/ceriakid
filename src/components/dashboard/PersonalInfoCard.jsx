...
export default function PersonalInfoCard({ user }) {
  ...
  return (
    <div
      className="rounded-3xl p-5 md:p-6 border border-white/20 shadow-xl"
      style={{ background: 'linear-gradient(135deg, rgba(255,255,255,0.18), rgba(255,255,255,0.08))', backdropFilter: 'blur(22px)' }}
    >

      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed left-4 top-6 z-50 h-[calc(100vh-3rem)] w-60 sm:w-72 bg-white/40 backdrop-blur-xl shadow-2xl pt-6 px-4 overflow-y-auto border border-white/30 rounded-3xl animate-float"
          >
            {/* Drawer Header */}

      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            style={{ background: 'linear-gradient(135deg, rgba(255, 140, 0, 0.85), rgba(255, 69, 0, 0.85))', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', border: '1px solid rgba(255, 140, 0, 0.4)' }}
          >
            {/* Header */}

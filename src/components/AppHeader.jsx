  ...
  return (
    <>
      ...
      <div className="fixed bottom-4 left-0 right-0 z-40 flex justify-center px-4">
        <div className={`w-full md:max-w-lg rounded-2xl px-3 sm:px-5 h-20 flex items-center justify-between ${
        isPlayingGame ?
      ...
      <AnimatePresence>
        ...
        <motion.div
          ...
          style={{ background: 'rgba(240, 242, 245, 0.85)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', border: '1px solid rgba(209, 213, 219, 0.5)' }}>

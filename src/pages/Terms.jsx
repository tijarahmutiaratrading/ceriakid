      ...
      <div className="max-w-3xl mx-auto bg-white rounded-3xl p-6 md:p-10 shadow-2xl">
        ...
        <div className="prose prose-slate max-w-none space-y-6 text-slate-700 leading-relaxed">
          ...
          <section>
            ...
            <p>Semua pelan adalah tahunan dan dibayar di hadapan melalui FPX. Langganan tidak akan diperbaharui secara automatik. Bayaran yang telah dibuat tidak boleh dikembalikan kecuali atas kebijaksanaan kami.</p>
          </section>

          <section>
            <h2 className="text-xl font-black text-slate-900">4. Had Peranti</h2>
            <p>Setiap pelan mempunyai had bilangan peranti yang dibenarkan. Untuk menukar peranti, sila urus melalui halaman Tetapan.</p>
          </section>

          <section>
            <h2 className="text-xl font-black text-slate-900">5. Kandungan Pengguna</h2>
          ...
          <section>
            <h2 className="text-xl font-black text-slate-900">6. Penamatan</h2>
          ...
          <section>
            <h2 className="text-xl font-black text-slate-900">7. Had Tanggungjawab</h2>

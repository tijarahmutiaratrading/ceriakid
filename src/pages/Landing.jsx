...
const testimonials = [
{ name: 'Nurul Ain', location: 'Shah Alam, Selangor', quote: 'Anak saya lebih mudah duduk buat latihan bila bentuknya macam game. Saya suka sebab topik dia tersusun dan tak terlalu berat.', stars: 5, avatar: 'https://api.dicebear.com/9.x/adventurer/svg?seed=NurulAin&backgroundColor=ffd5dc', highlight: 'anak lebih konsisten' },
{ name: 'Ismail Hashim', location: 'Johor Bahru, Johor', quote: 'Dashboard ibu bapa sangat membantu. Saya boleh nampak subjek mana anak selalu cuba dan mana yang perlu ulang semula.', stars: 5, avatar: 'https://api.dicebear.com/9.x/adventurer/svg?seed=IsmailHashim&backgroundColor=c0aede', highlight: 'mudah pantau progress' },
{ name: 'Rohani Bakar', location: 'Kota Bharu, Kelantan', quote: 'Pelan keluarga memang praktikal untuk rumah kami. Anak-anak boleh guna ikut peringkat masing-masing tanpa perlu banyak app berbeza.', stars: 5, avatar: 'https://api.dicebear.com/9.x/adventurer/svg?seed=RohaniBakar&backgroundColor=b6e3f4', highlight: 'sesuai untuk keluarga' },
{ name: 'Faridah Mohamad', location: 'Penang', quote: 'Saya kerja shift, jadi latihan pendek macam ni memudahkan anak belajar sendiri sekejap setiap hari.', stars: 5, avatar: 'https://api.dicebear.com/9.x/adventurer/svg?seed=FaridahMohamad&backgroundColor=ffdfbf', highlight: 'latihan harian lebih mudah' },
{ name: 'Ahmad Zulkifli', location: 'Kuching, Sarawak', quote: 'Saya suka interface dia ceria, mudah faham dan tidak terlalu serabut. Anak lebih selesa cuba soalan satu demi satu.', stars: 5, avatar: 'https://api.dicebear.com/9.x/adventurer/svg?seed=AhmadZulkifli&backgroundColor=d1d4f9', highlight: 'interface mesra anak' },
{ name: 'Siti Hajar', location: 'Ipoh, Perak', quote: 'Cuba versi percuma dulu, kemudian upgrade sebab kandungan dan susunan subjeknya sesuai untuk latihan di rumah.', stars: 5, avatar: 'https://api.dicebear.com/9.x/adventurer/svg?seed=SitiHajar&backgroundColor=c0e8d5', highlight: 'boleh cuba dahulu' }];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="inline-flex items-center gap-2 bg-white/12 border border-white/20 rounded-full px-4 py-2 mb-8 shadow-xl backdrop-blur-xl">
              ...
              <span className="text-xs font-black text-white/85">Dibina khas untuk <span className="text-yellow-300">anak Malaysia</span> 🇲🇾</span>
            </motion.div>
      ...
      <div id="features" className="py-12 md:py-16 px-6 relative">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-7 gap-4">
            ...
            map((s, i) =>
            <motion.div key={i} initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} whileHover={{ y: -4, scale: 1.03 }} transition={{ delay: i * 0.08 }} className={`relative overflow-hidden bg-gradient-to-br ${s.color} rounded-3xl p-4 text-center shadow-xl shadow-black/20 border border-white/30 min-h-[118px] flex flex-col items-center justify-center`}>

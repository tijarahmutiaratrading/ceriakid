...
export default function Landing() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50">
      ...
      {/* CTA */}
      <div className="bg-gradient-to-r from-game-purple to-game-pink text-white py-20">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-6">
          <h2 className="text-4xl font-black">Sedia Membuat Perbezaan?</h2>
          <p className="text-lg opacity-90">Berlangganan sekarang dan dapatkan akses ke semua 200+ permainan pembelajaran.</p>
          <Link to="/pricing">
            <motion.button
              whileHover={{ scale: 1.05 }}
              className="px-8 py-4 bg-white text-game-purple rounded-full font-bold"
            >
